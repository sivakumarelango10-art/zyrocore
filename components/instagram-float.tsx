...
export default function InstagramFloat() {
  ...
  return (
    ...
    >
      {/* QR Code Pop-up Card - Always Mounted in DOM with CSS Transitions for 0ms Instant Response */}
      <div
        onClick={handleDmClick}
        className={`bg-card/95 backdrop-blur-xl border border-border/80 rounded-2xl p-5 shadow-2xl w-64 text-center relative overflow-hidden cursor-pointer group hover:border-rose-500/50 transition-all duration-150 ease-out origin-bottom-right ${
          showQr
      ...
      >
        ...
        {/* Pre-decoded QR Code Image with Priority Preloading */}
      ...
      <div className="group relative flex items-center gap-2">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center justify-center w-13 h-13 rounded-full bg-gradient-to-tr from-amber-500 via-rose-500 to-purple-600 text-white shadow-[0_6px_24px_rgba(225,48,108,0.4)] hover:shadow-[0_10px_32px_rgba(225,48,108,0.6)] transform hover:-translate-y-0.5 active:scale-95 transition-all duration-200"
          >
            <Instagram className="w-6 h-6" />
          </button>
